        ...
        if getattr(queryset, 'subclasses', False):
            ...
            for obj in iter:
                ...
                if hasattr(obj, '_prefetched_objects_cache'):
                    setattr(sub_obj, '_prefetched_objects_cache', obj._prefetched_objects_cache)
...
class InheritanceQuerySetMixin:
    ...
    def annotate(self, *args, **kwargs):
        ...
        qset._annotated = getattr(self, '_annotated', []) + [a.default_alias for a in args] + list(kwargs.keys())
        return qset
